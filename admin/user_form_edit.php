		...
		<div class="main-container">
			<div class="xs-pd-20-10 pd-ltr-20">
				<div class="title pb-20">
					<h2 class="h3 mb-0">Student Update</h2>
				</div>

                <div class="card-box mb-30">
				<h2 class="h4 pd-20">Student Edit Form</h2>
				<div class="data-table table nowrap form-report"  enctype="multipart/form-data">
					
                    <form method="post" action="function_user_edit.php" enctype="multipart/form-data">
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Student Number</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="student_num" type="text" wfd-id="id26" value="<?php echo $user_row['student_num'] ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Name</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="student_name" type="text" wfd-id="id26" value="<?php echo $user_row['user_name'] ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Email</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="email" type="text" wfd-id="id26" value="<?php echo $user_row['user_email'] ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Password</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="password" type="text" wfd-id="id26">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Phone Number</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="phonum" type="text" wfd-id="id26" value="<?php echo $user_row['user_phonum'] ?>">
                            </div>
                        </div>
                        <div class="form-group row">
