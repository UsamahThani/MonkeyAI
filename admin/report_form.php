		...
		<div class="main-container">
			<div class="xs-pd-20-10 pd-ltr-20">
				...
				<div class="data-table table nowrap form-report">
                    ...
                    <form method="post" action="function_report.php">
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Admin Name</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="admin_name" type="text" wfd-id="id26" value="<?php echo $admin_name ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Location</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="location" type="text" placeholder="e.g Kolej TR" wfd-id="id26">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Date</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control date-picker" name="date" placeholder="Select Date" type="text" id="datepicker" wfd-id="id34">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Time</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control time-picker td-input" name="time" placeholder="Select time" type="text" readonly="" wfd-id="id36">
                            </div>
                        </div>
                        <div class="form-group row">
