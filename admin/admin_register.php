		...
		<div class="main-container">
			<div class="xs-pd-20-10 pd-ltr-20">
				<div class="title pb-20">
					<h2 class="h3 mb-0">Register Admin</h2>
				</div>

                <div class="card-box mb-30">
				<h2 class="h4 pd-20">Admin Register Form</h2>
				<div class="data-table table nowrap form-report"  enctype="multipart/form-data">
					
                    <form method="post" action="function_admin_register.php" enctype="multipart/form-data">
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Admin Name</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="admin_name" type="text" wfd-id="id26" placeholder="John Doe">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Email</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="email" type="text" wfd-id="id26" placeholder="email@domain.com">
                            </div>
                        </div>
                        <div class="form-group row">
