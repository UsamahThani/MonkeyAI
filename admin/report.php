<?php
    ...
    // Fetch report data
    $report_query = "SELECT report_id, report_location, report_date, report_time, report_context, report_admin FROM report";
                ...
                <div class="user-info-dropdown">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                            <a class="dropdown-item" href="../function_logout.php"><i class="dw dw-logout"></i> Log Out</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="left-side-bar">
            <div class="brand-logo">
                <a href="index.php">
                    ...
                    <img src="../images/monkeyailogo.png" alt="" class="light-logo" />
                </a>
            ...
            <div class="xs-pd-20-10 pd-ltr-20">
                ...
                <div class="card-box mb-30">
                    <div class="pd-20 flex-btn">
                        <h4 class="text-blue h4">List of Report</h4>
                        <a href="report_form.php" class="btn btn-info">Submit Report</a>
                    </div>
                    <div class="pb-20">
                                ...
                                if ($report_result->num_rows > 0) {
                                    ...
                                    while ($report_row = $report_result->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $report_row['report_location']; ?></td>
                                            <td><?php echo $report_row['report_date']; ?></td>
                                            <td><?php echo $report_row['report_time']; ?></td>
                                            <td><?php echo $report_row['report_context']; ?></td>
                                            <td><?php echo $report_row['report_admin']; ?></td>
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                        <a class="dropdown-item" href="report_form_edit.php?reportId=<?php echo $report_row['report_id']; ?>"><i class="dw dw-edit2"></i> Edit</a>
                                                        <a class="dropdown-item" href="function_report_delete.php?reportId=<?php echo $report_row['report_id']; ?>"><i class="dw dw-delete-3"></i> Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
